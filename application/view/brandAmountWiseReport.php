...
.chartContainer td
{
   border: 0px solid #000000;
    ...
    <script type="text/javascript">
            ...
            // setup the chart
            $('#amountChartContainer').jqxChart(settings2);
    </script>

    <div id='amountChartContainer'  class="chartContainer" style="width:40%;height:250px;float:right;display:inline-block;margin-right:5%;">
    </div>
