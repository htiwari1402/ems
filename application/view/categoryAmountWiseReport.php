...
.chartContainer td
{
   border: 0px solid #000000;
    ...
    <script type="text/javascript">
            ...
            // setup the chart
            $('#amountChartContainerCategory').jqxChart(settings2);
    </script>

    <div id='amountChartContainerCategory'  class="chartContainer" style="width:40%;height:250px;float:right;display:inline-block;margin-right:5%;">
    </div>
