...
.chartContainer
{
   ...
   margin-bottom:2%;
    ...
    <script type="text/javascript">
            ...
            // setup the chart
            $('#litreChartContainerCategory').jqxChart(settings);
    </script>

    <div id='litreChartContainerCategory'   class="chartContainer" style="width:40%; height:250px;float:left;display:inline-block;">
    </div>
