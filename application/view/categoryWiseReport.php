...
<br><br>
<form id="categoryWiseReportForm">
State: 
<select name="state">
...
<br>
<input type="button" class="nu" value="Generate Report" onclick="generateCategoryWiseReport();">

<br><br>
<div id="mainReportCategory" style="width:100%;">
</div>