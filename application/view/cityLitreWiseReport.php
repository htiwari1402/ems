...
.chartContainer
{
   ...
   margin-bottom:2%;
    ...
    <script type="text/javascript">
            ...
            // setup the chart
            $('#litreChartContainerCity').jqxChart(settings);
    </script>

    <div id='litreChartContainerCity'   class="chartContainer" style="width:40%; height:250px;float:left;display:inline-block;">
    </div>
