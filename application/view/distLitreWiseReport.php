...
.chartContainer
{
   ...
   margin-bottom:2%;
    ...
    <script type="text/javascript">
            ...
            // setup the chart
            $('#litreChartContainerDist').jqxChart(settings);
    </script>

    <div id='litreChartContainerDist'   class="chartContainer" style="width:40%; height:250px;float:left;display:inline-block;">
    </div>
