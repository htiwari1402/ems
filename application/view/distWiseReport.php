...
<br>
<input type="button" class="nu" value="Generate Report" onclick="generateDistWiseReport();">

<br><br>
<div id="mainReportDist" style="width:100%;">
</div>