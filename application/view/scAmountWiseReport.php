...
.chartContainer td
{
   border: 0px solid #000000;
    ...
    <script type="text/javascript">
            ...
            // setup the chart
            $('#amountChartContainerSC').jqxChart(settings2);
    </script>

    <div id='amountChartContainerSC'  class="chartContainer" style="width:40%;height:250px;float:right;display:inline-block;margin-right:5%;">
    </div>
