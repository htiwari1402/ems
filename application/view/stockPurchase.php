...
&nbsp;&nbsp;&nbsp;&nbsp;
<select id="salesLocSelect">
<option value="MH">MH</option>
<option value="MU">MU</option>
<option value="CS">CS</option>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;
<select id="salesTypeSelect">
...
<td>
<?php echo $purchaseEntryNo; ?>
<input type="hidden" name='purchaseEntryNo'  id="purchaseEntryNo" value="<?php echo $purchaseEntryNo; ?>">
</td>
</tr>
<tr class='oddTr'>
<td class='labelTd'>Party Invoice Number</td>
<td><input type="text" name="partyInvoiceNo" id="invoiceNo"></td>
</tr>
<tr class='evenTr'>
<td class='labelTd'>Party Inoice Date</td>
<td>
<input type="text" name="partyInvoiceDate" class="date"> 
</td>
</tr>
<tr class='oddTr'>
...
<td>
<input type="text" name="billOfEntryNo" > 
</td>
</tr>
<tr class='oddTr'>
...
<td>
<input type="text"  class="date" name="orderDate" > 
</td>
</tr>
</table>
...
<td><input type="text" name="blNo"></td>
</tr>
<tr class='oddTr'>
...
{?>
<option value="<?php echo $data['currencyName'];?>">
...
<td><input type="text" id='currencyRate' name="currencyRate"></td>
</tr>
<tr class='evenTr'>
...
<input type="hidden" name='supplierName' id='supplierShowName'>
</td>
</tr>
<tr class='oddTr' >
...
<td>
<input type="text" name='customDuty'>
</td>
</tr>
<tr class='oddTr' >
<td class='labelTd'>Clearing and forwarding charges</td>
<td>
<input type="text" name='cfCharges'>
</td>
</tr>
<tr class='evenTr' >
<td class='labelTd'>Shipment arrival date</td>
<td>
<input type="text" class="date"  name='shipDate'>
</td>
</tr>
<tr class='oddTr' >
<td class='labelTd'>BL Date</td>
<td>
<input type="text" class="date"  name='blDate'>
</td>
</tr>
</table>
</form>
...
<tr class='evenTr'>
<td valign="top">
<select name='itemCode[]'  id='itemCode_1'  onchange="displayAvailabilityDetailSP(1);">
<option>select</option>
<?php 
...
<td valign="top">
<select name='godownNo[]' id='godownNo_1'  class='smallInput' >
<option>select</option>
<?php 
...
<td valign="top"><input type="text" class='date smallInput' class='date' name="mfgDate[]" id="mfgDate_1"></td>
...
<td valign="top"><span class='currencySignID'></span><input type="text"  class='smallInput' name="amountCurr[]" id='amountCurr_1'  onfocus='calculateAmountCurr(1);' ></td>
<td valign="top"><span>Rs.</span><input type="text"  class='smallInput' name="amount[]" id='amount_1'  onfocus='calculateAmountInr(1);' ></td>
</tr>
</table>
</form>
...
<input type="button" class="nu"  id='submitInvoice'  value="Create Invoice" style="clear:both;margin-top:1%;margin:10px;" onclick="submitStockPurchase();">
</p>
</div>
<div id='testCode'>
</div>
