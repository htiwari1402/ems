...
foreach($rows as $key=>$data)
{
	?>
<tr>
<td><?php echo $data['purchaseEntryNo']; ?></td>
...
<td><input type="button" value="EDIT" class="nu" onclick="editStockPurchaseInvoice('<?php echo $data['purchaseEntryNo']; ?>')"></td>
</tr>	
	<?php 
}
echo "</table>";
