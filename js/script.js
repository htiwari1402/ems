	...
	$.post('./application/controller/control.php',
			...
			function(responseText)
			{
		   	...
		   	$('#loading').dialog('close');
		    	  //setTimeout(function(){ window.location.assign("home.php"); }, 2500);
...
{
	$.post(
 			'./application/controller/salesinvoicemaster.php',
 			'',
 			function(data)
 			{
 				$('#main').html(data);
...
{
	$.post(
 			'./application/controller/stockinvoicemaster.php',
 			'',
 			function(data)
 			{
 				$('#main').html(data);
...
{
	$.post(
 			'./application/controller/purchaseinvoicemaster.php',
 			'',
 			function(data)
 			{
 				$('#main').html(data);
